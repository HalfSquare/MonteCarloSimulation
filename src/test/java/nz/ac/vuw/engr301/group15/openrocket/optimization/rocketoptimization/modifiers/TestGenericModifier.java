package nz.ac.vuw.engr301.group15.openrocket.optimization.rocketoptimization.modifiers;

import static net.sf.openrocket.util.MathUtil.EPSILON;
import static org.junit.Assert.assertEquals;
import net.sf.openrocket.document.Simulation;
import net.sf.openrocket.optimization.general.OptimizationException;
import net.sf.openrocket.optimization.rocketoptimization.modifiers.GenericModifier;
import net.sf.openrocket.rocketcomponent.Rocket;
import net.sf.openrocket.unit.UnitGroup;
import nz.ac.vuw.engr301.group15.openrocket.util.BaseTestCase.BaseTestCase;
